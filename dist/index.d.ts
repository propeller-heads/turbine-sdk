...
declare const RPC_URL: string | undefined;
/**
 ...
 */
declare const W3_WEBSOCKET: string | undefined;
declare const W3_BLOCK_NUMBER_RPC_URL: string | undefined;
declare const MOCKED_TURBINE_POOL: {
    metadata: {
        token0: `0x${string}`;
        token1: `0x${string}`;
        fee: number;
